...
RSpec.describe WeatherFacade do
  describe 'building a forecast' do
    ...
    it 'builds current weather from map location', :vcr do
    ...
    it 'builds hourly forecast from map location 8 hours', :vcr do
    ...
    it 'builds a 5 day daily forcast from map location', :vcr do
    ...
    it 'builds the complete forecast by location', :vcr do
      ...
      response = WeatherFacade.weather_forecast('denver,co')[:data]
